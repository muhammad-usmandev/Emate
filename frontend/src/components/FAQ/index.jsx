                ...
                <div className="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8">
                    ...
                    <div className="py-5">
                        <details className="group">
                            ...
                            <p className="text-neutral-600 mt-3 group-open:animate-fadeIn">
                                Documentation is available on the company website and can be accessed by
                    ...
                    <div className="py-5">
                        <details className="group">
                            ...
                            <p className="text-neutral-600 mt-3 group-open:animate-fadeIn">
                                ...
                                deals and special offers, you can sign up for the company newsletter or follow it on social media.
                            </p>
                        </details>
                    </div>
                    <div className="py-5">
